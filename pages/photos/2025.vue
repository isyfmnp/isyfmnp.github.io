...
function fetchPhotos() {
  ...
  let gallery = []
  gallery.push(Object.values(import.meta.glob(`/assets/images/2025/day0/*.{png,jpg,jpeg,webp,PNG,JPEG,WEBP}`, { eager: true, query: '?url', import: 'default' })))
  gallery.push(Object.values(import.meta.glob(`/assets/images/2025/day1/*.{png,jpg,jpeg,webp,PNG,JPEG,WEBP}`, { eager: true, query: '?url', import: 'default' })))
  gallery.push(Object.values(import.meta.glob(`/assets/images/2025/day2/*.{png,jpg,jpeg,webp,PNG,JPEG,WEBP}`, { eager: true, query: '?url', import: 'default' })))
  gallery.push(Object.values(import.meta.glob(`/assets/images/2025/day3/*.{png,jpg,jpeg,webp,PNG,JPEG,WEBP}`, { eager: true, query: '?url', import: 'default' })))
  gallery.push(Object.values(import.meta.glob(`/assets/images/2025/day4/*.{png,jpg,jpeg,webp,PNG,JPEG,WEBP}`, { eager: true, query: '?url', import: 'default' })))
  gallery.push(Object.values(import.meta.glob(`/assets/images/2025/day5/*.{png,jpg,jpeg,webp,PNG,JPEG,WEBP}`, { eager: true, query: '?url', import: 'default' })))
